...
EMAIL_SUBJECT_PREFIX = '[Oscar jerusomar] '
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'

ALLOWED_HOSTS = ['jerusomar.herokuapp.com',
                 'jerusomar.dev']
...
INSTALLED_APPS = [
    ...
    # For profile testing
    'apps.user',
    # Sentry (for live jerusomar site)
...
THUMBNAIL_KEY_PREFIX = 'oscar-jerusomar'
...
# full checkout process of the jerusomar site locally then then you'll need to
